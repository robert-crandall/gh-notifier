# Handoff: GH Projects App — Dashboard & Project Detail

## Overview

GH Projects is a macOS desktop app (Electron + React + SQLite) for solo developers managing personal projects with GitHub integration. This handoff covers two primary screens: **Dashboard** and **Project Detail**, both using the selected "Option B" layout direction.
